      ...
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <div class="content">
               <div class="row">
                     <!-- Nav tabs -->
                     <div class="col-12 col-sm-12 col-md-12 col-lg-6 m-b-20">
                           <div class=" custom_tabs">
                             <div class="card2-body card_card">
                                 <ul class="nav nav-tabs" id="myTab1" role="tablist">
                                       <li class="nav-item">
                                         <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">my firsttab</a>
                                       </li>
                                       <li class="nav-item">
                                         <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">my secondtab</a>
                                       </li>
                                     </ul>
                        ...
                        <div class=" custom_tabs">
                          <div class="card2-body card_card">
                              <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                    <li class="nav-item">
                                      <a class="nav-link active" id="icon-tab" data-toggle="tab" href="#icon" role="tab" aria-controls="home" aria-selected="true"><i class="fa fa-home"></i></a>
                                    </li>
                                    <li class="nav-item">
                                      <a class="nav-link" id="icons-tab" data-toggle="tab" href="#icons" role="tab" aria-controls="profile" aria-selected="false"><i class="fa fa-television"></i></a>
                                    </li>
                                    <li class="nav-item">
                                      <a class="nav-link" id="iconss-tab" data-toggle="tab" href="#iconss" role="tab" aria-controls="profile" aria-selected="false"><i class="fa fa-area-chart"></i></a>
                                    </li>
                                  </ul>
                                  <div class="tab-content custom_tabs2" >
                                    <p><strong>Lorem Ipsum is simply dummy text of the printing and. </strong></p>
                                    <div class="tab-pane fade show active" id="icon" role="tabpanel" aria-labelledby="home-tab">
                                       <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. </p>
                                    </div>
                                    <div class="tab-pane fade" id="icons" role="tabpanel" aria-labelledby="profile-tab">
                                       <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. </p>
                                    </div>
                                    <div class="tab-pane fade" id="iconss" role="tabpanel" aria-labelledby="profile-tab">
                                       <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. </p>
                                    </div>
                                  </div>
                          </div>
               ...
               <div class="row ">
                  <div class="col-12 col-sm-12 col-md-12 col-lg-6  m-b-20">
                     <div class="row">
                           <div class="col-lg-3 col-md-3 col-sm-3 col-3 custom_pills">
                              <div class="nav flex-column nav-pills"  role="tablist" aria-orientation="vertical">
                                 <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">my firsttab</a>
                                 <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">my secondtab</a>
                              </div>
                           </div>
                           <div class="col-lg-9 col-md-9 col-sm-9 col-9 tab-border">
                  ...
                  <div class="col-12 col-sm-12 col-md-12 col-lg-6 m-b-20">
                     <div class="row">
                           <div class="col-lg-9 col-md-9 col-sm-9 col-9 tab-border1 ">
                              <div class="tab-content" >
                                 <p><strong>Lorem Ipsum is simply dummy text of the printing and. </strong></p>
                                 <div class="tab-pane fade show active" id="v-pills-home6" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                    <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
                                       The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content
                                       here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use
                                       Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy.
                                 ...
                                 <div class="tab-pane fade" id="v-pills-home7" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                    <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
                                       The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content
                                       here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use
                                       Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy.
                           ...
                           <div class="col-lg-3 col-md-3 col-sm-3 col-3 custom_pills3 tab-borderd">
                                 <div class="nav nav-pills "  role="tablist" aria-orientation="vertical">
                                    <a class="nav-link active" id="home6-tab" data-toggle="pill" href="#v-pills-home6" role="tab" aria-controls="v-pills-home" aria-selected="true">my firsttab</a>
                                    <a class="nav-link" id="profile6-tab" data-toggle="pill" href="#v-pills-home7" role="tab" aria-controls="v-pills-profile" aria-selected="false">my secondtab</a>
                                 </div>
                              </div>
                        </div>
                  </div>
               ...
               <div class="row">
                     <div class="col-12 col-sm-12 col-md-12 col-lg-6  m-b-20">
                           <div class="row">
                                 <div class="col-lg-2 col-md-2 col-sm-2 col-2 custom_pills4 sideways">
                                    <div class="nav flex-column nav-pills"  role="tablist" aria-orientation="vertical">
                                       <a class="nav-link active" id="v-pills-home9-tab" data-toggle="pill" href="#v-pills-home9" role="tab" aria-controls="v-pills-home" aria-selected="true">my firsttab</a>
                                       <a class="nav-link" id="v-pills-profile9-tab" data-toggle="pill" href="#v-pills-profile9" role="tab" aria-controls="v-pills-profile" aria-selected="false">my secondtab</a>
                                    </div>
                                 </div>
                                 <div class="col-lg-10 col-md-10 col-sm-10 col-10 tab-border">
                                    <div class="tab-content" >
                                       <p><strong>Lorem Ipsum is simply dummy text of the printing and. </strong></p>
                                       <div class="tab-pane fade show active" id="v-pills-home9" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                          <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
                                             The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content
                                             here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use
                                             Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy.
                                       ...
                                       <div class="tab-pane fade" id="v-pills-profile9" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                          <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
                                             The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content
                                             here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use
                                             Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy.
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 m-b-20">
                           <div class="row">
                                 <div class="col-lg-10 col-md-10 col-sm-10 col-10 tab-border1 ">
                                    <div class="tab-content" >
                                       <p><strong>Lorem Ipsum is simply dummy text of the printing and. </strong></p>
                                       <div class="tab-pane fade show active" id="v-pills-home11" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                          <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
                                             The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content
                                             here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use
                                             Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy.
                                       ...
                                       <div class="tab-pane fade" id="v-pills-home10" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                          <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
                                             The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content
                                             here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use
                                             Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy.
                                 ...
                                 <div class="col-lg-2 col-md-2 col-sm-2 col-2 pl-0 custom_pills5 tab-borderd sideways2">
                                       <div class="nav nav-pills "  role="tablist" aria-orientation="vertical">
                                          <a class="nav-link active rotate_a2 " id="home10-tab" data-toggle="pill" href="#v-pills-home11" role="tab" aria-controls="v-pills-home" aria-selected="true">my firsttab</a>
                                          <a class="nav-link rotate_a" id="profile10-tab" data-toggle="pill" href="#v-pills-home10" role="tab" aria-controls="v-pills-profile" aria-selected="false">my secondtab</a>
                                       </div>
                                    </div>
                              </div>
                        </div>
