                              ...
                              <div class="col-sm-3 p-0 inbox-nav">
                                 <div class="mailbox-sideber">
                                    <div class="profile-usermenu">
                                       <h6>Mailbox</h6>
                                       <div class="dropdown-menu1 item_perfect">
                                             <a class="dropdown-item perfect" href="#"><i class="fa fa-inbox"></i>Inbox <small class="label float-right bg1-green">61</small></a>
                                             <a class="dropdown-item" href="#"><i class="fa fa-envelope-o"></i>Send Mail</a>
                                             <a class="dropdown-item" href="#"><i class="fa fa-star-o"></i>Starred</a>
                                             <a class="dropdown-item" href="#"><i class="fa fa-trash-o"></i>Tresh</a>
                                             <a class="dropdown-item" href="#"><i class="fa fa-paperclip"></i>Attachments</a>
                                       </div>
                                       <hr>
                                       <h6>Other</h6>
                                       <div class="dropdown-menu1 item_perfect">
                                          <a class="dropdown-item perfect" href="#"><i class="fa fa-exclamation"></i>Spam <small class="label float-right bg1-green">61</small></a>
                                          <a class="dropdown-item" href="#"><i class="fa fa-file-text-o"></i>Draft</a>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-12 col-sm-12 col-md-12 col-lg-9  inbox-mail p-20">
                                 <div class="form-group row">
                                    <label class="col-sm-3 col-md-2 col-3  text-right">To:</label>
                                    <div class="col-sm-9 col-9">
                                       <input class="form-control" type="text"  id="to">
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    <label class="col-sm-3 col-md-2 col-3  text-right">Cc:</label>
                                    <div class="col-sm-9 col-9">
                                       <input class="form-control" type="text" id="cc">
                                    </div>
                                 </div>
                                 <div class="form-group row padding_from">
                                    <label class="col-sm-3 col-md-2 col-3  text-right">Subject:</label>
                                    <div class="col-sm-9 col-9">
