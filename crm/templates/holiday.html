         ...
         <div class="content-wrapper">
            ...
            <section class="content">
               <div class="row">
                     <div class="col-lg-12 pinpin">
                           <div class="card lobicard lobicard-custom-control"  data-sortable="true">
                               ...
                               <div class="card-body">
                                    <div class="row">
                                             <div class="col-md-4">
                                                <div class="nav flex-column nav-pills border_table" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                   <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-January" role="tab" aria-selected="true"><i class="ti-calendar"></i>  January</a>
                                                   <a class="nav-link"  data-toggle="pill" href="#v-pills-February" role="tab"  aria-selected="false"><i class="ti-calendar"></i>  February</a>
                                                   <a class="nav-link"  data-toggle="pill" href="#v-pills-March" role="tab"  aria-selected="false"><i class="ti-calendar"></i> March</a>
                                                   <a class="nav-link"  data-toggle="pill" href="#v-pills-April" role="tab" aria-selected="false"><i class="ti-calendar"></i>  April</a>
                                                   <a class="nav-link"  data-toggle="pill" href="#v-pills-May" role="tab"  aria-selected="false"><i class="ti-calendar"></i>  May</a>
                                                   <a class="nav-link"  data-toggle="pill" href="#v-pills-June" role="tab"  aria-selected="false"><i class="ti-calendar"></i>  June</a>
                                                   <a class="nav-link"  data-toggle="pill" href="#v-pills-July" role="tab"  aria-selected="false"><i class="ti-calendar"></i>  July</a>
                                                   <a class="nav-link"  data-toggle="pill" href="#v-pills-August" role="tab"  aria-selected="false"><i class="ti-calendar"></i>  August</a>
                                                   <a class="nav-link"  data-toggle="pill" href="#v-pills-September" role="tab"  aria-selected="false"><i class="ti-calendar"></i>  September</a>
                                                   <a class="nav-link"  data-toggle="pill" href="#v-pills-October" role="tab"  aria-selected="false"><i class="ti-calendar"></i>  October</a>
                                                   <a class="nav-link"  data-toggle="pill" href="#v-pills-November" role="tab"  aria-selected="false"><i class="ti-calendar"></i>  November</a>
                                                   <a class="nav-link"  data-toggle="pill" href="#v-pills-December" role="tab"  aria-selected="false"><i class="ti-calendar"></i>  December</a>
                                                </div>
                                             </div>
                                             <!-- Tab panels -->
                                             <div class="col-md-8">
                                                   <div class="tab-content full_tab_content" id="v-pills-tabContent">
                                                     <div class="tab-pane fade show active" id="v-pills-January" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                                               ...
                                                               <tbody>
                                                                  <tr>
                                                                     ...
                                                                     <td class="text-center">
                                                                        <button type="button" class="btn btn-add btn-sm" data-toggle="modal" data-target="#update-holiday">
                                                   ...
                                                   <div class="tab-pane fade" id="v-pills-February" role="tabpanel" >
                                                         <a href="#" class="btn btn-add btndate" data-toggle="modal" data-target="#addholiday"><i class="ti-calendar"></i> <strong>February</strong></a>  
                                                      <div class="table-responsive">
                                                            <table class="table table-bordered table-striped table-hover">
                                                               <thead class="back_table_color">
                                                                  <tr class="info">
                                                   ...
                                                   <div class="tab-pane fade" id="v-pills-March" role="tabpanel" >
                                                   ...
                                                   <div class="tab-pane fade" id="v-pills-April" role="tabpanel">
                                                   ...
                                                   <div class="tab-pane fade" id="v-pills-May" role="tabpanel" >
                                                   ...
                                                   <div class="tab-pane fade" id="v-pills-June" role="tabpanel">
                                                   ...
                                                   <div class="tab-pane fade" id="v-pills-July" role="tabpanel" >
                                                   ...
                                                   <div class="tab-pane fade" id="v-pills-August" role="tabpanel" >
                                                   ...
                                                   <div class="tab-pane fade" id="v-pills-September" role="tabpanel" >
                                                   ...
                                                   <div class="tab-pane fade" id="v-pills-October" role="tabpanel" >
                                                   ...
                                                   <div class="tab-pane fade" id="v-pills-November" role="tabpanel" >
                                                   ...
                                                   <div class="tab-pane fade" id="v-pills-December" role="tabpanel" >
                                                         <a href="#" class="btn btn-add btndate" data-toggle="modal" data-target="#add-holiday"><i class="ti-calendar"></i> <strong>December</strong></a>  
                                                      <div class="table-responsive">
                                                            <table class="table table-bordered table-striped table-hover">
                                                               <thead class="back_table_color">
                                                                  <tr class="info">
                ...
                <!-- add Modal1 -->
                <div class="modal fade" id="add-holiday" tabindex="-1" role="dialog"  aria-hidden="true">
                     <div class="modal-dialog modal-md" role="document">
                     <div class="modal-content">
                        <div class="modal-header">
                           <h3><i class="fa fa-user m-r-5"></i> Add holiday</h3>
               ...
               <!-- Update Modal1 -->
                <!-- add Modal1 -->
                <div class="modal fade" id="update-holiday" tabindex="-1" role="dialog"  aria-hidden="true">
                     <div class="modal-dialog modal-md" role="document">
                     <div class="modal-content">
                        <div class="modal-header">
                           <h3><i class="fa fa-user m-r-5"></i> Update</h3>
                           <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                           <span aria-hidden="true">&times;</span>
                           </button>
                        </div>
