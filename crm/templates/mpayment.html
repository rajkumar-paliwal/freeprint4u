                  ...
                  <ul class="sidebar-menu">
                     ...
                     <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                           ...
                           <li class="active"><a href="mpayment.html">Make payment</a></li>
               ...
               <div class="row">
                     <div class="col-lg-12 pinpin">
                           <div class="card lobicard lobicard-custom-control"  data-sortable="true">
                               ...
                               <div class="card-body">
                                    <form>
                                       <div class="col-lg-6 col-md-12 col-sm-12 col-12 offset-lg-3 form-group">
                                       ...
                                       <div class=" col-lg-6 form-group offset-lg-3 col-md-12 col-sm-12 col-12">
                                          <label> Start Date</label>
                                          <div class="input-group">
                                             <input id='minMaxExample' type="text" class="form-control">
                                             <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2"><a href="#"><i class="fa fa-calendar text-center"></i></a></span>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="col-lg-6 form-group offset-lg-3 col-md-12 col-sm-12 col-12">
