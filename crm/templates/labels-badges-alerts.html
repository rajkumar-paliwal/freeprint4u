                  ...
                  <ul class="sidebar-menu">
                     ...
                     <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                           ...
                           <li class="active"><a href="labels-badges-alerts.html">Labels, Badges, Alerts</a></li>
                        </ul>
                     </li>
                     <li class="treeview">
                        <a href="#">
               ...
               <div class="row">
                     <div class="col-lg-12 col-md-12 col-sm-12 col-12  pinpin">
                           <div class="card lobicard" id="lobicard-custom-control" data-sortable="true">
                               ...
                               <div class="card-body custom_alert_lebel">
                                    <div class="row">
                                       ...
                                       <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                          ...
                                          <!-- alerts -->
                                          <div class="alert custom_alerts alert-success alert-dismissible fade show" role="alert">
                                             <p><strong>Success!</strong> You successfully read this important alert message.</p>
                                             <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                             </button>
                                          </div>
                                          <div class="alert custom_alerts alert-info alert-dismissible fade show" role="alert">
                                             <p><strong>Success!</strong> You successfully read this important alert message.</p>
                                             <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                             </button>
                                          </div>
                                          <div class="alert custom_alerts alert-warning alert-dismissible fade show" role="alert">
                                             <p><strong>Success!</strong> You successfully read this important alert message.</p>
                                             <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                             </button>
                                          </div>
                                          <div class="alert custom_alerts alert-danger alert-dismissible fade show" role="alert">
                                             <p><strong>Success!</strong> You successfully read this important alert message.</p>
                                             <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                             </button>
